...
function modules() {
  ...
  // Swiper
  var swiper = gulp.src('./node_modules/swiper/**/*')
  ...
  return merge(bootstrap, fontAwesomeCSS, fontAwesomeWebfonts, jquery, swiper, jqueryEasing, simpleLineIconsFonts, simpleLineIconsCSS);
}
